...
def get_log_file_for_today(project_root_folder_path: Path) -> Path:
    ...
    base_folder = os.path.join(project_root_folder_path, "data", "chat_history", year, month)

    os.markedirs(base_folder, exist_ok=True)
...
def log_chat_message(log_file_path: Path, user_message: Optional[str] = None, ai_message: Optional[str] = None) -> None:
    """
    ...
    with open(log_file_path, "a") as log_file:
        ...
        if ai_message:
            log_file.write(f'{timestamp} - AI: {ai_message}\n')
